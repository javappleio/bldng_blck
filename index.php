...
<head>
    ...
    <link rel="stylesheet" href="./style/style.css?ver=<?php echo date("ymd-Gis", filemtime("./style/style.css")) ?>">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6 map">
                    ...
                    <p class="hint" id="hint">Click on the triangle vertices to learn more</p>
                </div>
            </div>
        </div>
    </section>
